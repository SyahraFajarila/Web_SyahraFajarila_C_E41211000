...
//parameter kedua 
//1. mendefinisikan klo class ini yang dipanggil
//2. nama methodnya
Route::prefix('management')->group(function(){
   Route::resource('user', ManagementUserController::class);
});
// Fungsi ini sama dengan fungsi index pada class ManagementUserController, hanya saja tidak berada di dalam sebuah class.
// variabel $nama dan $matkul akan dikirim ke view menggunakan fungsi compact.
Route::get('/', function () {
    $nama = "Syahra Fajarila";
